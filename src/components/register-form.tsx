                            ...
                            {formData.password && (
                                <div className="space-y-2 text-xs">
                                    <div className="flex items-center gap-2">
                                        {hasMinLength ? <CheckCircle2 className="h-3 w-3 text-green-500" /> : <XCircle className="h-3 w-3 text-gray-400" />}
                                        <span>At least 8 characters</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        {hasUpperCase ? <CheckCircle2 className="h-3 w-3 text-green-500" /> : <XCircle className="h-3 w-3 text-gray-400" />}
                                        <span>One uppercase letter</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        {hasLowerCase ? <CheckCircle2 className="h-3 w-3 text-green-500" /> : <XCircle className="h-3 w-3 text-gray-400" />}
                                        <span>One lowercase letter</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        {hasNumber ? <CheckCircle2 className="h-3 w-3 text-green-500" /> : <XCircle className="h-3 w-3 text-gray-400" />}
                        ...
                        <div className="flex items-center justify-between py-2">
                            ...
                            <Switch
                                ...
                                onCheckedChange={(value) =>
                                    setFormData(prev => ({ ...prev, isEmployee: value }))
                                }
                            />
                        </div>
